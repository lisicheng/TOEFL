...
glaze
{
Verb: Cover with a glaze or similar finish; Lose brightness and animation. Noun: A substance used to give a smoot, shiny surface to something.
}
glossy
glow
{
...
grace
{
Verb:Do honor or credit to(someone or something)by one's presence. Noun:Simple elegance or refinement of movement.
}
granite
{
...
groan
{
Noun: A deep inarticulate sound made in pain or despair. Verb: Make a deep inarticulate sound in response to pain or despair.
}
groom
{
...
gross
{
Adjective: Unattractively large or bloated; Verb: Produce or earn (an amount or money) as gross profit or income. esp. film.
}
grudge
{
Verb: Be resentfully unwilling to give, grant, or allow. Noun: A persistent feeling or ill will or resentment resulting from a past insult or injury.
}
gulf
hamper
//added
