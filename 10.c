disguise
{
Noun: A means of altering one's appearance or concealing one's identiy. mask, pretend.
}
conceal
{
...
dispose (of)
{
Verb: Get rid of by throwing away or giving or selling to someone else.
}
disrupt
disseminate
{
Verb: Spread or disperse (something, esp. information) widely.
}
distinct
{
Adjective: Recognizably different in nature from something else of a similar type.
}
distort
{
...
dubious
{
Adjective: Hesitaing or doubting.
}
ductile
{
...
eccentric
{
Adjective: (of a person or their behavior)Unconventional and slightly strange.
}
eclipse
edifice
{
Noun: A building, esp. a large, imposing one.
}
eject
elegant
{
...
elicit
{
Verb: Evoke or draw out(a response, answer, or fact) from someone in reaction to one's own actions.
}
eligible
{
